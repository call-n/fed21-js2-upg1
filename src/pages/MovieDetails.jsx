                ...
                <>
                    <Flex flexDirection={{lg: 'row', base: 'column'}}>
                        <Flex overflow="hidden" position="relative" zIndex="1" justifyContent="center">
                            <Box>
                                <img 
                                    src={MovieAPI.movieImagesEndpoint + '/' + data.poster_path}
                        ...
                        <Flex justifyContent="center">
                            <Flex flexDirection="column" maxWidth="40rem" paddingLeft={{lg: "3rem", md: "0rem"}}>
                                <Heading marginTop="2rem" marginBottom="1rem" fontSize="4xl">{data.original_title} ({data.release_date.substring(0, 4)})</Heading>
                                ...
                                <Wrap gap="3" fontWeight="600" marginBottom="1rem">
                                    ...
                                    {data.genres.map((genre, i) => (
                                        <Link key={i} to={'/genre/' + genre.id}>
                                            <Text color="#c58af9" _hover={{textDecor: "underline"}}>
                                                {genre.name},
                                            </Text>
                                        </Link>
                                    ))}
                    ...
                    <Heading marginTop="2rem" fontSize="4xl">
                    Cast
                    </Heading>
