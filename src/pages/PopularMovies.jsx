...
const PopularMovies = () => {
    const { data, error, isError, isLoading, isSuccess } = useQuery('popular-movies', MovieAPI.getAllPopular)

  return (
    <Box>
        <Heading marginTop="2rem" textAlign="center" fontSize="5xl">PopularMovies</Heading>
